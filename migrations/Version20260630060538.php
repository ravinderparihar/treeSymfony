 ...
 */
final class Version20260630060538 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comments CHANGE tree_id_id tree_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE likes CHANGE tree_id_id tree_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE likes ADD CONSTRAINT FK_49CA4E7D78B64A2 FOREIGN KEY (tree_id) REFERENCES tree (id)');
        $this->addSql('ALTER TABLE likes ADD CONSTRAINT FK_49CA4E7D9D86650F FOREIGN KEY (user_id_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_49CA4E7D78B64A2 ON likes (tree_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comments CHANGE tree_id tree_id_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE likes DROP FOREIGN KEY FK_49CA4E7D78B64A2');
        $this->addSql('ALTER TABLE likes DROP FOREIGN KEY FK_49CA4E7D9D86650F');
        $this->addSql('DROP INDEX IDX_49CA4E7D78B64A2 ON likes');
        $this->addSql('ALTER TABLE likes CHANGE tree_id tree_id_id INT DEFAULT NULL');
