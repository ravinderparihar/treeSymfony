 ...
 */
final class Version20260630110853 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tree DROP scientific_name, DROP english_name, DROP hindi_name');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tree ADD scientific_name VARCHAR(255) NOT NULL, ADD english_name VARCHAR(255) DEFAULT NULL, ADD hindi_name VARCHAR(255) DEFAULT NULL');
