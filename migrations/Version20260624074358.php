 ...
 */
final class Version20260624074358 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tree CHANGE tree_categories_id tree_category_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tree CHANGE tree_category_id tree_categories_id INT DEFAULT NULL');
