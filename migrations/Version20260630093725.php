 ...
 */
final class Version20260630093725 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tree_usages (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_0900_ai_ci` ENGINE = MyISAM COMMENT = \'\' ');
        $this->addSql('CREATE TABLE tree_usages_tree (tree_usages_id INT NOT NULL, tree_id INT NOT NULL, INDEX IDX_6747AB1A78B64A2 (tree_id), INDEX IDX_6747AB1A303EF3C6 (tree_usages_id), PRIMARY KEY (tree_usages_id, tree_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_0900_ai_ci` ENGINE = MyISAM COMMENT = \'\' ');
        $this->addSql('CREATE TABLE tree_usages_user (tree_usages_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_5DEA238FA76ED395 (user_id), INDEX IDX_5DEA238F303EF3C6 (tree_usages_id), PRIMARY KEY (tree_usages_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_0900_ai_ci` ENGINE = MyISAM COMMENT = \'\' ');
