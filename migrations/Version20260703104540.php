 ...
 */
final class Version20260703104540 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE favorites ADD tree_favorite_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_E46960F5DDEB6B73 ON favorites (tree_favorite_id)');
        ...
        $this->addSql('ALTER TABLE likes ADD tree_likes_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_49CA4E7D4CEF9C24 ON likes (tree_likes_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_E46960F5DDEB6B73 ON favorites');
        $this->addSql('ALTER TABLE favorites DROP tree_favorite_id');
        ...
        $this->addSql('DROP INDEX IDX_49CA4E7D4CEF9C24 ON likes');
        $this->addSql('ALTER TABLE likes DROP tree_likes_id');
