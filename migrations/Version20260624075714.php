 ...
 */
final class Version20260624075714 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tree (id INT AUTO_INCREMENT NOT NULL, scientific_name VARCHAR(255) NOT NULL, english_name VARCHAR(255) DEFAULT NULL, hindi_name VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, lifespan_min VARCHAR(255) NOT NULL, lifespan_max VARCHAR(255) NOT NULL, height_min VARCHAR(255) DEFAULT NULL, height_max VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, status TINYINT DEFAULT NULL, tree_images_id INT DEFAULT NULL, tree_category_id INT DEFAULT NULL, INDEX IDX_B73E5EDC13FB61BA (tree_images_id), INDEX IDX_B73E5EDC65BABE8C (tree_category_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
