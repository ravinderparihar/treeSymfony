 ...
 */
final class Version20260630104348 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tree ADD family_name VARCHAR(255) DEFAULT NULL, ADD genus VARCHAR(255) DEFAULT NULL, ADD species VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tree DROP family_name, DROP genus, DROP species');
