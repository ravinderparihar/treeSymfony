 ...
 */
final class Version20260701121849 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comments ADD tree_id INT NOT NULL, ADD user_id INT NOT NULL, DROP tree_id_id, CHANGE comment comment LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comments ADD tree_id_id INT DEFAULT NULL, DROP tree_id, DROP user_id, CHANGE comment comment VARCHAR(255) NOT NULL');
