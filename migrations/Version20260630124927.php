 ...
 */
final class Version20260630124927 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tree DROP growthRate');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tree ADD growthRate VARCHAR(255) NOT NULL');
