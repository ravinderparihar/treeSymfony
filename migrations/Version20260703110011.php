 ...
 */
final class Version20260703110011 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comments ADD CONSTRAINT FK_5F9E962A14CBB6E8 FOREIGN KEY (tree_comments_id) REFERENCES tree (id)');
        $this->addSql('ALTER TABLE favorites ADD CONSTRAINT FK_E46960F5A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE favorites ADD CONSTRAINT FK_E46960F5DDEB6B73 FOREIGN KEY (tree_favorite_id) REFERENCES tree (id)');
        ...
        $this->addSql('ALTER TABLE likes ADD CONSTRAINT FK_49CA4E7D4CEF9C24 FOREIGN KEY (tree_likes_id) REFERENCES tree (id)');
        $this->addSql('ALTER TABLE tree_attributes ADD CONSTRAINT FK_CA88667178B64A2 FOREIGN KEY (tree_id) REFERENCES tree (id)');
        $this->addSql('ALTER TABLE tree_category_map ADD tree_categories_id INT NOT NULL, ADD tree_categories_map_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE tree_category_map ADD CONSTRAINT FK_1C12B79DFB0B5410 FOREIGN KEY (tree_categories_id) REFERENCES tree (id)');
        $this->addSql('ALTER TABLE tree_category_map ADD CONSTRAINT FK_1C12B79D723D8D68 FOREIGN KEY (tree_categories_map_id) REFERENCES tree_categories (id)');
        $this->addSql('CREATE INDEX IDX_1C12B79DFB0B5410 ON tree_category_map (tree_categories_id)');
        $this->addSql('CREATE INDEX IDX_1C12B79D723D8D68 ON tree_category_map (tree_categories_map_id)');
        ...
        $this->addSql('ALTER TABLE tree_images ADD CONSTRAINT FK_DD7F299B78B64A2 FOREIGN KEY (tree_id) REFERENCES tree (id)');
        ...
        $this->addSql('ALTER TABLE tree_uses ADD CONSTRAINT FK_45178CE878B64A2 FOREIGN KEY (tree_id) REFERENCES tree (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comments DROP FOREIGN KEY FK_5F9E962A14CBB6E8');
        $this->addSql('ALTER TABLE favorites DROP FOREIGN KEY FK_E46960F5A76ED395');
        $this->addSql('ALTER TABLE favorites DROP FOREIGN KEY FK_E46960F5DDEB6B73');
        ...
        $this->addSql('ALTER TABLE likes DROP FOREIGN KEY FK_49CA4E7D4CEF9C24');
        ...
        $this->addSql('ALTER TABLE tree_category_map DROP FOREIGN KEY FK_1C12B79DFB0B5410');
        $this->addSql('ALTER TABLE tree_category_map DROP FOREIGN KEY FK_1C12B79D723D8D68');
        $this->addSql('DROP INDEX IDX_1C12B79DFB0B5410 ON tree_category_map');
        $this->addSql('DROP INDEX IDX_1C12B79D723D8D68 ON tree_category_map');
        $this->addSql('ALTER TABLE tree_category_map DROP tree_categories_id, DROP tree_categories_map_id');
