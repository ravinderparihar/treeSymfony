 ...
 */
final class Version20260630105125 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tree ADD evergreen TINYINT NOT NULL, ADD native_country VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tree DROP evergreen, DROP native_country');
