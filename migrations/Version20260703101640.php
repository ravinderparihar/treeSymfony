 ...
 */
final class Version20260703101640 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_9A29F62A78B64A2 ON tree_local_names');
        $this->addSql('ALTER TABLE tree_local_names DROP tree_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tree_local_names ADD tree_id INT NOT NULL');
        $this->addSql('CREATE INDEX IDX_9A29F62A78B64A2 ON tree_local_names (tree_id)');
