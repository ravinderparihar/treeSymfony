 ...
 */
final class Version20260630122416 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_B73E5EDC65BABE8C ON tree');
        $this->addSql('ALTER TABLE tree CHANGE tree_category_id category_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE tree ADD CONSTRAINT FK_B73E5EDC13FB61BA FOREIGN KEY (tree_images_id) REFERENCES tree_images (id)');
        $this->addSql('ALTER TABLE tree ADD CONSTRAINT FK_B73E5EDC12469DE2 FOREIGN KEY (category_id) REFERENCES tree_categories (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tree DROP FOREIGN KEY FK_B73E5EDC12469DE2');
        $this->addSql('DROP INDEX IDX_B73E5EDC12469DE2 ON tree');
        $this->addSql('ALTER TABLE tree CHANGE category_id tree_category_id INT DEFAULT NULL');
        $this->addSql('CREATE INDEX IDX_B73E5EDC65BABE8C ON tree (tree_category_id)');
