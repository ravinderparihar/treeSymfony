 ...
 */
final class Version20260702051238 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_9A29F62AC746B832 ON tree_local_names');
        $this->addSql('ALTER TABLE tree_local_names CHANGE tree_id_id tree_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tree_local_names CHANGE tree_id tree_id_id INT NOT NULL');
        $this->addSql('CREATE INDEX IDX_9A29F62AC746B832 ON tree_local_names (tree_id_id)');
