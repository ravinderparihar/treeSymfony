 ...
 */
final class Version20260624105710 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tree_categories ADD description LONGTEXT DEFAULT NULL, DROP text');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tree_categories ADD text VARCHAR(255) DEFAULT NULL, DROP description');
