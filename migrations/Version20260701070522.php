 ...
 */
final class Version20260701070522 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tree_category_map (id INT AUTO_INCREMENT NOT NULL, tree_id INT NOT NULL, category_id INT NOT NULL, INDEX IDX_1C12B79D78B64A2 (tree_id), INDEX IDX_1C12B79D12469DE2 (category_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
