 ...
 */
final class Version20260703104153 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comments ADD tree_comments_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_5F9E962A14CBB6E8 ON comments (tree_comments_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_5F9E962A14CBB6E8 ON comments');
        $this->addSql('ALTER TABLE comments DROP tree_comments_id');
