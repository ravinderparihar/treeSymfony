 ...
 */
final class Version20260630111141 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tree CHANGE growth_rate growthRate VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tree CHANGE growthRate growth_rate VARCHAR(255) NOT NULL');
