 ...
 */
final class Version20260630065651 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE likes CHANGE tree_id treeId INT DEFAULT NULL, CHANGE user_id userId INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE likes CHANGE treeId tree_id INT DEFAULT NULL, CHANGE userId user_id INT NOT NULL');
