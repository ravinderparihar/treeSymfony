 ...
 */
final class Version20260703065751 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_B73E5EDC13FB61BA ON tree');
        $this->addSql('ALTER TABLE tree DROP tree_images_id');
        ...
        $this->addSql('ALTER TABLE tree_images ADD tree_id INT NOT NULL');
        $this->addSql('ALTER TABLE tree_images ADD CONSTRAINT FK_DD7F299B78B64A2 FOREIGN KEY (tree_id) REFERENCES tree (id)');
        $this->addSql('CREATE INDEX IDX_DD7F299B78B64A2 ON tree_images (tree_id)');
        ...
        $this->addSql('ALTER TABLE tree_uses ADD tree_id INT NOT NULL');
        $this->addSql('ALTER TABLE tree_uses ADD CONSTRAINT FK_45178CE878B64A2 FOREIGN KEY (tree_id) REFERENCES tree (id)');
        $this->addSql('CREATE INDEX IDX_45178CE878B64A2 ON tree_uses (tree_id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE tree_uses_tree (tree_uses_id INT NOT NULL, tree_id INT NOT NULL, INDEX IDX_C157A5EF78B64A2 (tree_id), INDEX IDX_C157A5EFD55516ED (tree_uses_id), PRIMARY KEY (tree_uses_id, tree_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_0900_ai_ci` ENGINE = MyISAM COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE tree ADD tree_images_id INT DEFAULT NULL');
        $this->addSql('CREATE INDEX IDX_B73E5EDC13FB61BA ON tree (tree_images_id)');
        ...
        $this->addSql('DROP INDEX IDX_DD7F299B78B64A2 ON tree_images');
        $this->addSql('ALTER TABLE tree_images DROP tree_id');
        ...
        $this->addSql('DROP INDEX IDX_45178CE878B64A2 ON tree_uses');
        $this->addSql('ALTER TABLE tree_uses DROP tree_id');
    }
}
