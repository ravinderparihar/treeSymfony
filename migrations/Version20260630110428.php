 ...
 */
final class Version20260630110428 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tree ADD growth_rate VARCHAR(255) NOT NULL, DROP evergreen, DROP native_country');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tree ADD evergreen TINYINT NOT NULL, ADD native_country VARCHAR(255) DEFAULT NULL, DROP growth_rate');
