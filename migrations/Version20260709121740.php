 ...
 */
final class Version20260709121740 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comments (id INT AUTO_INCREMENT NOT NULL, comment LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_0900_ai_ci`, tree_id INT NOT NULL, user_id INT NOT NULL, tree_comments_id INT DEFAULT NULL, INDEX IDX_5F9E962A14CBB6E8 (tree_comments_id), INDEX IDX_5F9E962A78B64A2 (tree_id), INDEX IDX_5F9E962AA76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_0900_ai_ci` ENGINE = MyISAM COMMENT = \'\' ');
        $this->addSql('CREATE TABLE favorites (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, tree_favorite_id INT DEFAULT NULL, INDEX IDX_E46960F5A76ED395 (user_id), INDEX IDX_E46960F5DDEB6B73 (tree_favorite_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_0900_ai_ci` ENGINE = MyISAM COMMENT = \'\' ');
        $this->addSql('CREATE TABLE favorites_tree (favorites_id INT NOT NULL, tree_id INT NOT NULL, INDEX IDX_2CFDC0AE78B64A2 (tree_id), INDEX IDX_2CFDC0AE84DDC6B4 (favorites_id), PRIMARY KEY (favorites_id, tree_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_0900_ai_ci` ENGINE = MyISAM COMMENT = \'\' ');
        $this->addSql('CREATE TABLE likes (id INT AUTO_INCREMENT NOT NULL, type INT NOT NULL, treeId INT DEFAULT NULL, userId INT NOT NULL, tree_likes_id INT DEFAULT NULL, INDEX IDX_49CA4E7D4CEF9C24 (tree_likes_id), INDEX IDX_49CA4E7D64B64DCC (userId), INDEX IDX_49CA4E7D8BE3022C (treeId), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_0900_ai_ci` ENGINE = MyISAM COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE tree_category_map (id INT AUTO_INCREMENT NOT NULL, tree_id INT DEFAULT NULL, category_id INT DEFAULT NULL, INDEX IDX_1C12B79D12469DE2 (category_id), INDEX IDX_1C12B79D78B64A2 (tree_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_0900_ai_ci` ENGINE = MyISAM COMMENT = \'\' ');
