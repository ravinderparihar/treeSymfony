 ...
 */
final class Version20260701101240 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tree CHANGE category_id categories_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE tree ADD CONSTRAINT FK_B73E5EDC13FB61BA FOREIGN KEY (tree_images_id) REFERENCES tree_images (id)');
        $this->addSql('ALTER TABLE tree ADD CONSTRAINT FK_B73E5EDCA21214B7 FOREIGN KEY (categories_id) REFERENCES tree_categories (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tree DROP FOREIGN KEY FK_B73E5EDCA21214B7');
        $this->addSql('DROP INDEX IDX_B73E5EDCA21214B7 ON tree');
        $this->addSql('ALTER TABLE tree CHANGE categories_id category_id INT DEFAULT NULL');
