 ...
 */
final class Version20260716120327 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_E01FBE6A78B64A2 ON images');
        $this->addSql('ALTER TABLE images ADD treeId INT DEFAULT NULL, DROP tree_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE images ADD tree_id INT NOT NULL, DROP treeId');
        $this->addSql('CREATE INDEX IDX_E01FBE6A78B64A2 ON images (tree_id)');
