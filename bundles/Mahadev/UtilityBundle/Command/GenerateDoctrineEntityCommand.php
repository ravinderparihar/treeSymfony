...
use Mahadev\UtilityBundle\Generator\DoctrineEntityGenerator;
...
class GenerateDoctrineEntityCommand extends GenerateDoctrineCommand
{
    ...
    public function __construct(KernelInterface $kernel,
                                ...
                                ManagerRegistry $managerRegistry, ParameterBagInterface $parameterBag
    )
    {
        parent::__construct();
        $this->kernel = $kernel;
...
EOT
    ...
    protected function interact(InputInterface $input, OutputInterface $output): void
    {
        ...
        while (true) {
            ...
            $question->setValidator([Validators::class, 'validateEntityName']);
            ...
            try {
                $b = $this->kernel->getBundle($bundle);
        ...
        $question->setValidator(array('Mahadev\UtilityBundle\Command\Validators', 'validateFormat'));
    ...
    {
        return new DoctrineEntityGenerator($this->filesystem, $this->managerRegistry);
    }
}