...
use Mahadev\UtilityBundle\Model\Bundle;
use Symfony\Component\Console\Input\InputOption;
use Symfony\Component\Console\Input\InputInterface;
use Symfony\Component\Console\Output\OutputInterface;
use Symfony\Component\Console\Question\Question;
use Symfony\Component\Console\Question\ConfirmationQuestion;
use Mahadev\UtilityBundle\Generator\BundleGenerator;
    ...
    protected function configure(): void
    {
        $this
            ...
            ->setDefinition(array(
                ...
                new InputOption('format', '', InputOption::VALUE_REQUIRED, 'Use the format for configuration files (php, xml, yml, or annotation)', 'xml'),
                new InputOption('shared', '', InputOption::VALUE_OPTIONAL, 'Are you planning on sharing this bundle across multiple applications?', true),
            ))
            ->setHelp(<<<EOT
...
//        }
    ...
    protected function createBundleObject(InputInterface $input)
    {
        ...
        $projectRootDirectory = $this->parameterBag->get('kernel.project_dir');
