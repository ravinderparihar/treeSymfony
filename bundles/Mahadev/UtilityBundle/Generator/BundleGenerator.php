...
namespace Mahadev\UtilityBundle\Generator;
...
//        $this->renderFile('bundle/index.html.twig.twig', $dir.'/Resources/views/Default/index.html.twig', $parameters);
        ...
        if($bundle->getConfigurationFormat() == 'xml'){
            $this->renderFile(
                sprintf('bundle/%s.twig', 'services.yaml'),
                $dir.'/Resources/config/services.yaml', $parameters
            );
        }

        $this->renderFile(
            sprintf('bundle/%s.twig', 'dummy.yaml'),
            $dir.'/Resources/config/api_resources/dummy.yaml', $parameters
        );

        $this->renderFile(
            sprintf('bundle/%s.twig', 'dummy.yaml'),
            $dir.'/Resources/config/serialization/dummy.yaml', $parameters
        );
